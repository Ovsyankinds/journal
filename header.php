...
<nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a href="ticket_system_view.php" class="nav-link">Задания электронщикам</a>
      </li>
      <li class="nav-item">
...
<!-- Div главной надписи на странице -->
  <?
    //По названию страницы выбираем какой заголовок показывать
    $str = $_SERVER['REQUEST_URI'];
    $str = trim($str, '/');
    //echo $str;
    switch($str){
      case 'journal_of_breakdowns.php':
        $header_text = "Журнал электронщиков";
        break;

      case 'journal_of_breakdowns_electric.php':
        $header_text = "Журнал электриков";
        break;

      case 'ticket_system_view.php':
        $header_text = "Задания для электронщиков";
        break;
    }
  ?>

  <div class="row text-center">
	 <div class="col-md-12" id = "header_journal_of_breakdowns"> <?=$header_text?> </div> 
  </div>
<!-- конец div'a главной надписи на странице -->