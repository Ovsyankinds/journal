...
<div class = "row justify-content-center" id="form-add-note">
	...
	<form name = "add_new_message_electric" method = "POST" 
		...
		<div class=" form-group col-md-3 text-center">
			<label for = "name_machine" class="col-form-label label-form-input-note"> Название линии </label>
		...
		<div class="form-group col-md-3 text-center">
			<label for = "call_time" class="col-from-label label-form-input-note"> Время вызова </label>
