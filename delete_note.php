...
<div id = "delete_message_of_journal_breackdowns">
	<form name = "delete_message" method = "POST" action = "delete_message_of_journal_breackdowns.php">
		...
		<input type = "submit" name = "delete_message_of_journal" value = "Удалить выбранную запись" />
	</form>
</div>
