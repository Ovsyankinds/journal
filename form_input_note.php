...
<div class = "add_new_message">
	...
	<form name = "add_new_message" method = "POST" action = "journal_of_breakdowns.php">
		<p>
		...
		<input type = "submit" name = "show_form_add_new_message_to_journal" value = "Добавить новую запись"/>
	</form>
</div>
...
?>
	...
	<form name = "add_new_message" method = "POST" 
		action = "add_new_message_to_journal.php" 
		...
		<input type = "submit" name = "add_new_message_to_journal">
	</form>
</div>
